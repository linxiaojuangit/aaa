...
fileName='MaCOM_daily_20230701_t_7day.nc'
filePath = './'+fileName #macom数据
# filepath='Users/liuchunda/Desktop/obs/2023/07/20230701120000-UKMO-L4_GHRSST-SSTfnd-OSTIA-GLOB-v02.0-fv02.0.nc'
...
if len(filePath) > 0:
    ...
    fore_sst = fid1.variables['t'][0,0,:, :]  #('time', 'depth', 'lat', 'lon')  49depth
